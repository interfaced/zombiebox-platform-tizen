...
export default class Input extends AbstractInput {
	...
	_createKeysMap() {
		...
		map[TvKeyCode.KEY_LEFT] = Key.LEFT;
		map[TvKeyCode.KEY_RIGHT] = Key.RIGHT;
		map[TvKeyCode.KEY_UP] = Key.UP;
		map[TvKeyCode.KEY_DOWN] = Key.DOWN;

		map[TvKeyCode.KEY_0] = Key.DIGIT_0;
		map[TvKeyCode.KEY_1] = Key.DIGIT_1;
		map[TvKeyCode.KEY_2] = Key.DIGIT_2;
		map[TvKeyCode.KEY_3] = Key.DIGIT_3;
		map[TvKeyCode.KEY_4] = Key.DIGIT_4;
		map[TvKeyCode.KEY_5] = Key.DIGIT_5;
		map[TvKeyCode.KEY_6] = Key.DIGIT_6;
		map[TvKeyCode.KEY_7] = Key.DIGIT_7;
		map[TvKeyCode.KEY_8] = Key.DIGIT_8;
		map[TvKeyCode.KEY_9] = Key.DIGIT_9;

		map[TvKeyCode.KEY_MEDIA_PLAY] = Key.PLAY;
		map[TvKeyCode.KEY_MEDIA_PAUSE] = Key.PAUSE;
		map[TvKeyCode.KEY_MEDIA_PLAY_PAUSE] = Key.PLAY_PAUSE;
		map[TvKeyCode.KEY_MEDIA_STOP] = Key.STOP;
		map[TvKeyCode.KEY_MEDIA_FAST_FORWARD] = Key.FWD;
		map[TvKeyCode.KEY_MEDIA_REWIND] = Key.REW;

		map[TvKeyCode.KEY_BACK] = Key.BACK;
		map[TvKeyCode.KEY_ENTER] = Key.ENTER;
		map[TvKeyCode.KEY_MENU] = Key.MENU;
		map[TvKeyCode.KEY_INFO] = Key.INFO;
		map[TvKeyCode.KEY_CHANNEL_UP] = Key.PAGE_UP;
		map[TvKeyCode.KEY_CHANNEL_DOWN] = Key.PAGE_DOWN;

		map[TvKeyCode.KEY_VOLUME_DOWN] = Key.VOLUME_DOWN;
		map[TvKeyCode.KEY_VOLUME_UP] = Key.VOLUME_UP;

		map[TvKeyCode.KEY_COLOR_F0_RED] = Key.RED;
		map[TvKeyCode.KEY_COLOR_F1_GREEN] = Key.GREEN;
		map[TvKeyCode.KEY_COLOR_F2_YELLOW] = Key.YELLOW;
		map[TvKeyCode.KEY_COLOR_F3_BLUE] = Key.BLUE;

		map[TvKeyCode.KEY_EXIT] = Key.EXIT;
		map[TvKeyCode.KEY_VOLUME_MUTE] = Key.MUTE;
